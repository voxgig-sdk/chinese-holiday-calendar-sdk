...
type Args struct {
	Entity string         `json:"entity" jsonschema:"holiday"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ChineseHolidayCalendarSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "chinese-holiday-calendar_list",
		Description: "List records from ChineseHolidayCalendar. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "chinese-holiday-calendar_load",
		Description: "Load a single record from ChineseHolidayCalendar. " +
...
func runOp(client *sdk.ChineseHolidayCalendarSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ChineseHolidayCalendarSDK, name string) (sdk.ChineseHolidayCalendarEntity, error) {
