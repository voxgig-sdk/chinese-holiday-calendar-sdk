// Command ChineseHolidayCalendar-mcp is an MCP server exposing the ChineseHolidayCalendar
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ChineseHolidayCalendar_list  — list records of an entity
//	ChineseHolidayCalendar_load  — load a single record of an entity
//
