...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("CHINESEHOLIDAYCALENDAR_TEST_LIVE") == "TRUE" ||
		os.Getenv("CHINESEHOLIDAYCALENDAR_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("CHINESEHOLIDAYCALENDAR_TEST_EXPLAIN"); explain != "" {
