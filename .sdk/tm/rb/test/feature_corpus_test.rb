# ChineseHolidayCalendar SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # ChineseHolidayCalendarSDK.new, not ChineseHolidayCalendarSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    ChineseHolidayCalendarSDK.new(opts)
  end
