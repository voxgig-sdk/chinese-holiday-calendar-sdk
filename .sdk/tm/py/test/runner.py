...
class ChineseHolidayCalendarTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ChineseHolidayCalendarTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ChineseHolidayCalendarTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ChineseHolidayCalendarTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
