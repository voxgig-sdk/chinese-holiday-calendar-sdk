...
local function make_error_util(ctx, err)
  ...
  local msg = "ChineseHolidayCalendarSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = ChineseHolidayCalendarError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == ChineseHolidayCalendarError then
