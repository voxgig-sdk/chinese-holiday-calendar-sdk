...
// ChineseHolidayCalendar SDK utility: fetcher

class ChineseHolidayCalendarFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ChineseHolidayCalendarSDK/1.0)';
    ...
    public static function call(ChineseHolidayCalendarContext $ctx, string $fullurl, array $fetchdef): array
    {
