...
// ChineseHolidayCalendar SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ChineseHolidayCalendarMakeRequest
{
    public static function call(ChineseHolidayCalendarContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ChineseHolidayCalendarResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ChineseHolidayCalendarResponse($fetched);
        } else {
