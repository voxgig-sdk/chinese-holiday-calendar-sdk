...
// ChineseHolidayCalendar SDK utility: graphql
//
...
class ChineseHolidayCalendarGraphql
{
    ...
    // equivalent.
    public static function body(ChineseHolidayCalendarContext $ctx): mixed
    {
    ...
    public static function errors(ChineseHolidayCalendarContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
