...
// ChineseHolidayCalendar SDK netsim feature
...
class ChineseHolidayCalendarNetsimFeature extends ChineseHolidayCalendarBaseFeature
{
    ...
    private function _simulate(ChineseHolidayCalendarContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ChineseHolidayCalendarContext $ctx, array $applied): void
    {
        $client = $this->client;
