...
describe("HolidayEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CHINESE_HOLIDAY_CALENDAR_TEST_HOLIDAY_ENTID JSON to run live")
      return
    end
...
function holiday_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CHINESE_HOLIDAY_CALENDAR_TEST_HOLIDAY_ENTID")
  ...
  if env["CHINESE_HOLIDAY_CALENDAR_TEST_LIVE"] == "TRUE" then
