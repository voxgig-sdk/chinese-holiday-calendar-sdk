...
function runner.env_override(m)
  local live = runner.getenv("CHINESE_HOLIDAY_CALENDAR_TEST_LIVE")
  local override = runner.getenv("CHINESE_HOLIDAY_CALENDAR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CHINESE_HOLIDAY_CALENDAR_TEST_EXPLAIN")
