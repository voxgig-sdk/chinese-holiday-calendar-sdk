...
function runner.env_override(m)
  local live = runner.getenv("CHINESEHOLIDAYCALENDAR_TEST_LIVE")
  local override = runner.getenv("CHINESEHOLIDAYCALENDAR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CHINESEHOLIDAYCALENDAR_TEST_EXPLAIN")
