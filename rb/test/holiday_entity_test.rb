...
class HolidayEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CHINESEHOLIDAYCALENDAR_TEST_HOLIDAY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def holiday_basic_setup(extra)
  ...
  entid_env_raw = ENV["CHINESEHOLIDAYCALENDAR_TEST_HOLIDAY_ENTID"]
