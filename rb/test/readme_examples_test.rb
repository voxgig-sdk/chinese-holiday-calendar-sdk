...
#      offline in seeded test mode (ChineseHolidayCalendarSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ChineseHolidayCalendar_sdk.rb")
  SDK_CLASS = "ChineseHolidayCalendarSDK"
  ...
  SDK_BASE = "ChineseHolidayCalendar_sdk"
