# ChineseHolidayCalendar Ruby SDK Reference

Complete API reference for the ChineseHolidayCalendar Ruby SDK.
...
#### `ChineseHolidayCalendarSDK.test(testopts = nil, sdkopts = nil)`
