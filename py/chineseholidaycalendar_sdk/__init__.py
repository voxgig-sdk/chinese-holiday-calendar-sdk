...
from chineseholidaycalendar_sdk.utility import register

# Load features
from chineseholidaycalendar_sdk.feature.base_feature import ChineseHolidayCalendarBaseFeature
from chineseholidaycalendar_sdk.features import _has_feature, _make_feature
...
class ChineseHolidayCalendarSDK:
    ...
    def get_utility(self):
        return ChineseHolidayCalendarUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ChineseHolidayCalendarSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Holiday(self, data=None) -> "HolidayEntity":
        ...
        from chineseholidaycalendar_sdk.entity.holiday_entity import HolidayEntity
