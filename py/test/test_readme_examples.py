# ChineseHolidayCalendar SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ChineseHolidayCalendarSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ChineseHolidayCalendarSDK(...) and ChineseHolidayCalendarSDK.test(...) become
#      ChineseHolidayCalendarSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "chineseholidaycalendar_sdk"
_SDK_CLASS = "ChineseHolidayCalendarSDK"
