# ChineseHolidayCalendar Python SDK Reference

Complete API reference for the ChineseHolidayCalendar Python SDK.
...
#### `ChineseHolidayCalendarSDK.test(testopts=None, sdkopts=None)`
