# ChineseHolidayCalendar TypeScript SDK Reference

Complete API reference for the ChineseHolidayCalendar TypeScript SDK.
...
```ts
new ChineseHolidayCalendarSDK(options?: object)
```
...
#### `ChineseHolidayCalendarSDK.test(testopts?, sdkopts?)`
...
**Returns:** `ChineseHolidayCalendarSDK` instance in test mode.
...
Alias for `ChineseHolidayCalendarSDK.test()`.
...
Return the parent `ChineseHolidayCalendarSDK` instance.
