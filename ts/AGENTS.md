# ChineseHolidayCalendar TypeScript — Agent Guide

The TypeScript client for the ChineseHolidayCalendar API. This directory is **generated** — do not edit it by hand; change the model/template/component in `.sdk/` and regenerate. See the [project guide](../AGENTS.md) for the full workflow and the aontu model language.
