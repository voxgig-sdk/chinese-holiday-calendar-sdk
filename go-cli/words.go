...
func registerSDKWords(r *eng.Registry, client *sdk.ChineseHolidayCalendarSDK) {
...
func runOp(client *sdk.ChineseHolidayCalendarSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
