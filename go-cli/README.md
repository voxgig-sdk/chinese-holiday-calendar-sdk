...
AQL-driven CLI and REPL for the ChineseHolidayCalendar SDK. Positional arguments are
...
```sh
go build -o chinese-holiday-calendar-cli ./...
```
...
./chinese-holiday-calendar-cli list holiday
./chinese-holiday-calendar-cli load 1 holiday
./chinese-holiday-calendar-cli load '{id:1}' holiday
