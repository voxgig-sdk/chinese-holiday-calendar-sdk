...
// ChineseHolidayCalendar SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ChineseHolidayCalendarSDK::test)
...
{
    private const SDK_CLASS = 'ChineseHolidayCalendarSDK';
    ...
    private const SDK_BASE = 'chineseholidaycalendar_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../chineseholidaycalendar_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
