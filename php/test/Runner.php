...
class ChineseHolidayCalendarTestRunner
{
    ...
    {
        $live = self::getenv('CHINESE_HOLIDAY_CALENDAR_TEST_LIVE');
        $override = self::getenv('CHINESE_HOLIDAY_CALENDAR_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CHINESE_HOLIDAY_CALENDAR_TEST_EXPLAIN');
...
class_alias('ChineseHolidayCalendarTestRunner', 'Runner');
class_alias('ChineseHolidayCalendarHelpers', 'Helpers');
