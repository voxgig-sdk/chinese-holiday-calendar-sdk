...
class ChineseHolidayCalendarTestRunner
{
    ...
    {
        $live = self::getenv('CHINESEHOLIDAYCALENDAR_TEST_LIVE');
        $override = self::getenv('CHINESEHOLIDAYCALENDAR_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CHINESEHOLIDAYCALENDAR_TEST_EXPLAIN');
