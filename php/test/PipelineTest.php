...
// ChineseHolidayCalendar SDK pipeline test
//
...
{
    private static function utility(): ChineseHolidayCalendarUtility
    {
        return new ChineseHolidayCalendarUtility();
    }
    ...
    private static function ctx(array $over = []): ChineseHolidayCalendarContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ChineseHolidayCalendarContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ChineseHolidayCalendarOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ChineseHolidayCalendarError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ChineseHolidayCalendarOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ChineseHolidayCalendarMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ChineseHolidayCalendarOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ChineseHolidayCalendarMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ChineseHolidayCalendarOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ChineseHolidayCalendarMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ChineseHolidayCalendarSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ChineseHolidayCalendarMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ChineseHolidayCalendarResponse([]),
            'result' => new ChineseHolidayCalendarResult([]),
        ]);
        [, $err] = ChineseHolidayCalendarMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ChineseHolidayCalendarSpec([]),
            'response' => null,
            'result' => new ChineseHolidayCalendarResult([]),
        ]);
        [, $err] = ChineseHolidayCalendarMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ChineseHolidayCalendarSpec(['step' => 's']),
            'response' => new ChineseHolidayCalendarResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ChineseHolidayCalendarResult([]),
        ]);
        [, $err] = ChineseHolidayCalendarMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ChineseHolidayCalendarSpec(['step' => 's']),
            'response' => new ChineseHolidayCalendarResponse(self::resp(200, ['v' => 1])),
            'result' => new ChineseHolidayCalendarResult([]),
        ]);
        [, $err] = ChineseHolidayCalendarMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ChineseHolidayCalendarSpec(['step' => 's']),
            'response' => new ChineseHolidayCalendarResponse(self::resp(200, ['v' => 2])),
            'result' => new ChineseHolidayCalendarResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ChineseHolidayCalendarMakeResponse::call($ctx);
    ...
    {
        $preset = new ChineseHolidayCalendarResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ChineseHolidayCalendarSpec([]),
            'response' => new ChineseHolidayCalendarResponse([]),
            'result' => new ChineseHolidayCalendarResult([]),
        ...
        [$got, $err] = ChineseHolidayCalendarMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ChineseHolidayCalendarResult([])]);
        [, $err] = ChineseHolidayCalendarMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ChineseHolidayCalendarSpec([]), 'result' => null]);
        [, $err] = ChineseHolidayCalendarMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ChineseHolidayCalendarSpec(['step' => 's']),
            'result' => new ChineseHolidayCalendarResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ChineseHolidayCalendarOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ChineseHolidayCalendarMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ChineseHolidayCalendarSpec(['step' => 's']),
            'result' => new ChineseHolidayCalendarResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ChineseHolidayCalendarOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ChineseHolidayCalendarMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ChineseHolidayCalendarResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ChineseHolidayCalendarSpec([]),
            'result' => new ChineseHolidayCalendarResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ChineseHolidayCalendarMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ChineseHolidayCalendarMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ChineseHolidayCalendarError('boom', 'boom');
        $utility->fetcher = function (ChineseHolidayCalendarContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ChineseHolidayCalendarSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ChineseHolidayCalendarMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ChineseHolidayCalendarContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ChineseHolidayCalendarMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ChineseHolidayCalendarResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ChineseHolidayCalendarMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ChineseHolidayCalendarContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ChineseHolidayCalendarSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ChineseHolidayCalendarMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ChineseHolidayCalendarResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ChineseHolidayCalendarSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ChineseHolidayCalendarMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ChineseHolidayCalendarMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ChineseHolidayCalendarMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ChineseHolidayCalendarResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ChineseHolidayCalendarDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ChineseHolidayCalendarResult(['ok' => false])]);
        $this->expectException(ChineseHolidayCalendarError::class);
        ChineseHolidayCalendarDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ChineseHolidayCalendarResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ChineseHolidayCalendarMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ChineseHolidayCalendarMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ChineseHolidayCalendarBaseFeature();
        $b = new ChineseHolidayCalendarBaseFeature();
        ChineseHolidayCalendarFeatureAdd::call($ctx, $a);
        ChineseHolidayCalendarFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ChineseHolidayCalendarBaseFeature
    {
        $f = new ChineseHolidayCalendarBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ChineseHolidayCalendarFeatureAdd::call($ctx, self::named_feature('a'));
        ChineseHolidayCalendarFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        ChineseHolidayCalendarFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        ChineseHolidayCalendarFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        ChineseHolidayCalendarFeatureAdd::call($ctx, $replace);
        ...
        ChineseHolidayCalendarFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ChineseHolidayCalendarContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ChineseHolidayCalendarSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ChineseHolidayCalendarPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ChineseHolidayCalendarPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ChineseHolidayCalendarResponse(['headers' => null]),
            'result' => new ChineseHolidayCalendarResult([]),
        ]);
        ChineseHolidayCalendarResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ChineseHolidayCalendarResultBody::call($ctx);
