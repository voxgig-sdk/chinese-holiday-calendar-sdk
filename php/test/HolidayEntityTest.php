...
class HolidayEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CHINESEHOLIDAYCALENDAR_TEST_HOLIDAY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function holiday_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CHINESEHOLIDAYCALENDAR_TEST_HOLIDAY_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["CHINESEHOLIDAYCALENDAR_TEST_HOLIDAY_ENTID"]);
