...
// ChineseHolidayCalendar SDK ratelimit feature
...
class ChineseHolidayCalendarRatelimitFeature extends ChineseHolidayCalendarBaseFeature
{
    ...
    private function _acquire(ChineseHolidayCalendarContext $ctx): void
    {
    ...
    private function _track(ChineseHolidayCalendarContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
