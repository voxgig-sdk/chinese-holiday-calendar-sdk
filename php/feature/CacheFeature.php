...
// ChineseHolidayCalendar SDK cache feature
...
class ChineseHolidayCalendarCacheFeature extends ChineseHolidayCalendarBaseFeature
{
    ...
    private function _through(ChineseHolidayCalendarContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
