...
// ChineseHolidayCalendar SDK proxy feature
...
class ChineseHolidayCalendarProxyFeature extends ChineseHolidayCalendarBaseFeature
{
    ...
    public function init(ChineseHolidayCalendarContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ChineseHolidayCalendarContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
