...
// ChineseHolidayCalendar SDK audit feature
...
class ChineseHolidayCalendarAuditFeature extends ChineseHolidayCalendarBaseFeature
{
    ...
    private function _emit(ChineseHolidayCalendarContext $ctx, string $outcome): void
    {
