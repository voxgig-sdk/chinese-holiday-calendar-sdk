...
// ChineseHolidayCalendar SDK clienttrack feature
...
class ChineseHolidayCalendarClienttrackFeature extends ChineseHolidayCalendarBaseFeature
{
    ...
    public function PostConstruct(ChineseHolidayCalendarContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ChineseHolidayCalendar-SDK';
