...
// ChineseHolidayCalendar SDK rbac feature
...
class ChineseHolidayCalendarRbacFeature extends ChineseHolidayCalendarBaseFeature
{
    ...
    private function _required(ChineseHolidayCalendarContext $ctx): ?string
    {
    ...
    private function _reject(ChineseHolidayCalendarContext $ctx, string $required): void
    {
    ...
    private function _track(ChineseHolidayCalendarContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
