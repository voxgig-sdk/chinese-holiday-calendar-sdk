...
// ChineseHolidayCalendar SDK metrics feature
...
class ChineseHolidayCalendarMetricsFeature extends ChineseHolidayCalendarBaseFeature
{
    ...
    private function _record(ChineseHolidayCalendarContext $ctx, bool $ok): void
    {
