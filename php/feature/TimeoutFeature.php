...
// ChineseHolidayCalendar SDK timeout feature
...
class ChineseHolidayCalendarTimeoutFeature extends ChineseHolidayCalendarBaseFeature
{
    ...
    private function _with_timeout(ChineseHolidayCalendarContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ChineseHolidayCalendarContext $_ctx, float $ms): void
    {
        $client = $this->client;
