...
// ChineseHolidayCalendar SDK debug feature
...
class ChineseHolidayCalendarDebugFeature extends ChineseHolidayCalendarBaseFeature
{
    ...
    private function _finish(ChineseHolidayCalendarContext $ctx, bool $ok): void
    {
