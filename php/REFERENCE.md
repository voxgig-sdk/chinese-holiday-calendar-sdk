# ChineseHolidayCalendar PHP SDK Reference

Complete API reference for the ChineseHolidayCalendar PHP SDK.
...
#### `ChineseHolidayCalendarSDK::test($testopts = null, $sdkopts = null)`
