...
// ChineseHolidayCalendar SDK utility: result_basic

class ChineseHolidayCalendarResultBasic
{
    public static function call(ChineseHolidayCalendarContext $ctx): ?ChineseHolidayCalendarResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof ChineseHolidayCalendarError) ? $result->err->msg : (string)$result->err;
