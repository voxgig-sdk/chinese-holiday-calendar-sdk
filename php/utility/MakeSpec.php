...
// ChineseHolidayCalendar SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class ChineseHolidayCalendarMakeSpec
{
    public static function call(ChineseHolidayCalendarContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = ChineseHolidayCalendarGraphql::CONTENT_TYPE;
        } else {
