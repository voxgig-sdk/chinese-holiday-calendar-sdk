...
// ChineseHolidayCalendar SDK utility type

class ChineseHolidayCalendarUtility
{
    ...
    public static function copy(ChineseHolidayCalendarUtility $src): ChineseHolidayCalendarUtility
    {
        $u = new ChineseHolidayCalendarUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
